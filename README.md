# New Webpack Project
This project is based on [this](https://zenn.dev/sakata_kazuma/articles/d999fe91cce114) article.
2022/09/29

## Index
1. package.jsonを作成
1. 初期設定
1. browserslistの設定（autoprefixerの設定）
1. webpackの設定用JSファイルを作成
1. package.jsonへコマンドを追加
1. ビルドコマンド
